...
import com.sck2.jenkins.client.ConfigFile;
import com.sck2.jenkins.client.jersey2.JenkinsJersey2Client;
 ...
 */
public class testJenkinsJersey2Client {

    private JenkinsEnv env = new JenkinsEnv();
    private JenkinsJersey2Client client = JenkinsJersey2Client.get(env);
