...
import com.sck2.jenkins.client.jersey1.JenkinsJersey1Client;
 ...
 */
public class testJenkinsJersey1Client {

    private JenkinsEnv env = new JenkinsEnv();
    private JenkinsJersey1Client client = JenkinsJersey1Client.get(env);
